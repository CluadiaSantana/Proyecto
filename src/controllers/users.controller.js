...
class UsersController {
    static sign(req, res) {
        ...
        if (!userName || !password || !email || !role) { //Si no se encuentra algun dato mandar a error 
        ...
        database.insertOne({ //Funcion insertOne que se encuentra en 'models' se manda a llamar
                ...
                if (role == "student") { //Si el rol es student se llama a la funcion signUser() del Student Controller
                    StudentController.signUser(id)
                } else if (role == "teacher") { //Si el rol es teacher se llama a la funcion signUser() del Student Controller
